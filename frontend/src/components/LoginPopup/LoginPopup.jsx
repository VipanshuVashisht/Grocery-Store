    ...
    <div className='login-popup'>
        <form onSubmit={onLogin} className="login-popup-container">
            ...
            <div className="login-popup-condition">
                ...
                <p>By continuing, I agree all the terms & conditions</p>
            </div>
            {
                currState === "Login"
                ? <p>New User? <span onClick={()=>setCurrState("Sign Up")}>Create account</span> </p>
                : <p>Aready have an account? <span onClick={()=>setCurrState("Login")}>Login</span> </p>
            }
